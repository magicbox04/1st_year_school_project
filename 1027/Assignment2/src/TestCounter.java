...
public class TestCounter {
	...
	private static String[][] tests = new String [][] {
		...
		new String[] {"H","Q","D","K","D","J","S","Q","C","9"}, // pair and run 
		new String[] {"C","K","H","A","H","8","H","10","H","3"}, // flush
	...
	private static void runTest (int i) 
	{
		...
		if (act == exp) {
			System.out.print("Test " + (i+1) + " Passed");
			System.out.println("   You got " + act + " and should be " + exp);
		} else {
